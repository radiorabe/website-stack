...
export interface ItemsPrograms {
  ...
  image?: string | Files | null;
  content?: any;
  promo_box?: number | ItemsPromoBox | null;
...
export interface ItemsPageTeam {
  ...
  members_it?: (number | ItemsPageTeamDirectusUsers3)[] | null;
  members_rabe_info?: (number | ItemsPageTeamDirectusUsers4)[] | null;
}
...
export interface ItemsEventsEditorNodes {
  ...
  id?: string;
  events_id?: number | ItemsEvents | null;
  item?: (string | ItemsImageBox | ItemsQuote | ItemsInfoBox | ItemsIframe | ItemsAudioPlayer)[] | null;
  collection?: string | null;
}
...
export interface ItemsPageHome {
  id?: number;
  user_updated?: string | Users | null;
  /** @format timestamp */
  date_updated?: string | null;
...
export interface ItemsPromoBox {
  id?: number;
  title?: string;
  text?: string | null;
  button_label?: string | null;
...
export interface ItemsPageTeamDirectusUsers3 {
  id?: number;
  page_team_id?: number | ItemsPageTeam | null;
  directus_users_id?: string | Users | null;
}

export interface ItemsPageTeamDirectusUsers4 {
  id?: number;
  page_team_id?: number | ItemsPageTeam | null;
  directus_users_id?: string | Users | null;
}
...
export interface ReadItemsPageHomeParams {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** A limit on the number of objects that are returned. */
  limit?: number;
...
export interface ReadItemsPageHomeData {
  data?: ItemsPageHome[];
  meta?: XMetadata;
}

export interface ReadSingleItemsPageHomeParams {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** What metadata to return in the response. */
  meta?: string;
...
export interface ReadSingleItemsPageHomeData {
  data?: ItemsPageHome;
}
...
export interface ReadItemsPromoBoxParams {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** A limit on the number of objects that are returned. */
  limit?: number;
...
export interface ReadItemsPromoBoxData {
  data?: ItemsPromoBox[];
  meta?: XMetadata;
}

export interface ReadSingleItemsPromoBoxParams {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** What metadata to return in the response. */
  meta?: string;
...
export interface ReadSingleItemsPromoBoxData {
  data?: ItemsPromoBox;
}
...
export interface ReadItemsPageTeamDirectusUsers3Params {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** A limit on the number of objects that are returned. */
  limit?: number;
...
export interface ReadItemsPageTeamDirectusUsers3Data {
  data?: ItemsPageTeamDirectusUsers3[];
  meta?: XMetadata;
}

export interface ReadSingleItemsPageTeamDirectusUsers3Params {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** What metadata to return in the response. */
  meta?: string;
...
export interface ReadSingleItemsPageTeamDirectusUsers3Data {
  data?: ItemsPageTeamDirectusUsers3;
}

export interface ReadItemsPageTeamDirectusUsers4Params {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** A limit on the number of objects that are returned. */
  limit?: number;
...
export interface ReadItemsPageTeamDirectusUsers4Data {
  data?: ItemsPageTeamDirectusUsers4[];
  meta?: XMetadata;
}

export interface ReadSingleItemsPageTeamDirectusUsers4Params {
  /** Control what fields are being returned in the object. */
  fields?: string[];
  /** What metadata to return in the response. */
  meta?: string;
...
export interface ReadSingleItemsPageTeamDirectusUsers4Data {
  data?: ItemsPageTeamDirectusUsers4;
}
