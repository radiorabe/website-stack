...
export type TipTapNodeHandler<T extends TipTapBaseNode = TipTapBaseNode> =
  (props: { children: React.ReactNode; node: T }) => JSX.Element;

export type TipTapMarkHandler<T extends TipTapBaseMark = TipTapBaseMark> =
  (props: { children: React.ReactNode; node: T }) => JSX.Element;
